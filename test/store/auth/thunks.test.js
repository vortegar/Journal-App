...
import { checkingAuthentication, startGoogleSignIn, startLoginWhitEmailPassword, startLogout } from '../../../src/store/auth/thunks';
...
describe('Pruebas en AuthThunks', () => {
    ...
    test('startLoginWhitEmailPassword debe de llamar checkingCredentials y login exitoso', async() => {
